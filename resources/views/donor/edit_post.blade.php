        ...
        <div class ="containner">
            <div class="row pt-5">
                ...
                <div class="col-md-6 col-md-offset-2 pt-5">
                    ...
                    @endif
                    <form method="POST" action="{{ route('donor/updated_post')}}" >
                        @csrf
                        <input type="hidden" name="id" value="{{$posts->id}}">
                        <div class="form-group">
                            <label for="title">Post Title : <span class="require"></span></label>
                            <input type="text" name="title" class="form-control" name="title" value="{{$posts->title}}" />
                        </div>

                        <div class="form-group">
                            <label for="description">Description :</label>
                            <textarea name="description" rows="5" class="form-control" name="description"> {{$posts->description}} </textarea>
                        </div>
